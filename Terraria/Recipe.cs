...
namespace Terraria
{
	public class Recipe
	{
		...
		public static int maxRecipes = 1300;
		...
		{
			return (reqType == 9 || reqType == 619 || reqType == 620 || reqType == 621 || reqType == 911 || reqType == 1729) && (this.anyWood && (invType == 9 || invType == 619 || invType == 620 || invType == 621 || invType == 911 || invType == 1729));
		}
		...
		public static void SetupRecipes()
		{
			...
			Recipe.newRecipe.requiredItem[0].SetDefaults("Glass");
			Recipe.newRecipe.requiredItem[0].stack = 20;
			Recipe.newRecipe.requiredItem[1].SetDefaults("Amber");
			Recipe.newRecipe.requiredTile[0] = 18;
			Recipe.addRecipe();
			...
			Recipe.newRecipe.requiredItem[0].SetDefaults(664, false);
			Recipe.newRecipe.requiredItem[0].stack = 6;
			Recipe.newRecipe.requiredItem[1].SetDefaults("Ice Torch");
			Recipe.newRecipe.requiredTile[0] = 306;
			Recipe.addRecipe();
			...
			Recipe.newRecipe.requiredItem[0].SetDefaults("Ice Torch");
			Recipe.newRecipe.requiredItem[1].SetDefaults(664, false);
			Recipe.newRecipe.requiredItem[1].stack = 3;
			Recipe.newRecipe.requiredTile[0] = 306;
			Recipe.addRecipe();
			...
			Recipe.newRecipe.requiredItem[0].SetDefaults("Torch");
			Recipe.newRecipe.requiredItem[1].SetDefaults("Bone");
			Recipe.newRecipe.requiredItem[1].stack = 3;
			Recipe.newRecipe.requiredTile[0] = 300;
			Recipe.addRecipe();
