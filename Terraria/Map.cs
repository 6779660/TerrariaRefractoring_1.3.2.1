	...
	public class Map
	{
		...
		public static void Initialize()
		{
			...
			for (int n = 0; n < 314; n++)
			{
				...
				int num8 = 0;
				while (num8 < 10 && !(array7[num8] == Map.transparent))
				{
					num8++;
				}
			...
			for (int num9 = 0; num9 < 145; num9++)
			{
				...
				int num10 = 0;
				while (num10 < 2 && !(array8[num10] == Map.transparent))
				{
					num10++;
				}
			...
			Map.colorLookup[0] = Map.transparent;
			ushort num11 = 1;
