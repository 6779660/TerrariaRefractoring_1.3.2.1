																				...
																				for (int num47 = num45; num47 < num45 + (int)num44; num47++)
																				{
																					for (int num48 = num46; num48 < num46 + (int)num44; num48++)
																					{
																						...
																						if (Main.tile[num47, num48].active())
																						{
																							...
																							{
																								if (!flag6 || (int)Main.tile[num47, num48].type != type2)
																								{
																							...
																							else
																							{
																								...
																								else
																								{
																									if (b == 26)
																									{
																										...
																										num++;
																										int num64 = (int)(this.readBuffer[num] - 1);
																										num++;
																									...
																									else
																									{
																										...
																										else
																										{
																											if (b == 28)
																											{
																												...
																												num += 4;
																												int num76 = (int)(this.readBuffer[num] - 1);
																												num++;
																															...
																															else
																															{
																																...
																																else
																																{
																																	if (b == 35)
																																	{
																																		...
																																		num += 2;
																																		if (num91 != Main.myPlayer || Main.ServerSideCharacter)
																																		{
																																			Main.player[num91].HealEffect(num92, true);
																																		}
																																		if (Main.netMode == 2)
																																		{
																																					...
																																					else
																																					{
																																						...
																																						else
																																						{
																																							if (b == 42)
																																							{
																																								...
																																								{
																																									if (Main.myPlayer == num95 && !Main.ServerSideCharacter)
																																									{
																																										return;
																																									}
																																								}
																																							...
																																							else
																																							{
																																								if (b == 43)
																																								{
																																									...
																																									num += 2;
																																									if (num96 != Main.myPlayer)
																																									{
																																										Main.player[num96].ManaEffect(num97);
																																									}
																																									if (Main.netMode == 2)
																																									{
																																								...
																																								else
																																								{
																																									if (b == 44)
																																									{
																																										...
																																										num++;
																																										int num98 = (int)(this.readBuffer[num] - 1);
																																										num++;
																																																													...
																																																													else
																																																													{
																																																														if (b == 66)
																																																														{
																																																															...
																																																															if (num144 > 0)
																																																															{
																																																																...
																																																																Main.player[num143].HealEffect(num144, false);
																																																																if (Main.netMode == 2)
																																																																{
																																																														...
																																																														else
																																																														{
																																																															...
																																																															if (b == 69)
																																																															{
																																																																...
																																																																if (Main.netMode == 1)
																																																																{
																																																																	...
																																																																	{
																																																																		if (chest3.x != (int)num146 || chest3.y != (int)num147)
																																																																		{
																																																																			return;
																																																																		}
																																																																	}
