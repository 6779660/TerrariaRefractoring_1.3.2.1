	...
	public class Lang
	{
		...
		public static string dialog(int l, bool english = false)
		{
			...
			if (Lang.lang <= 1 || english)
			{
				...
				case 179:
					return "Press " + KeyBoardDefinitions.cInv + " to access your crafting menu. When you have enough wood, create a workbench. This will allow you to create more complicated things, as long as you are standing close to it.";
				case 180:
		...
		public static string itemName(int l, bool english = false)
		{
			if (Lang.lang <= 1 || english)
			{
				...
				case 2237:
					return "Dynasty Grandfather Clock";
				case 2238:
					return "Golden Grandfather Clock";
				case 2239:
					return "Glass Grandfather Clock";
				case 2240:
					return "Honey Grandfather Clock";
				case 2241:
					return "Steampunk Grandfather Clock";
				case 2242:
					return "Fancy Dishes";
				case 2243:
					return "Glass Bowl";
